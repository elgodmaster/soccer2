...
<h1>
	...
	<p class="note">
		...
		<?php echo $form->dropDownList($documentModel,'ID_DOCUMENT',CHtml::listData($catDocumentModel::model()->findAllByAttributes(array('TYPE_DOCUMENT'=>1)),'ID','NAME'),array('id'=>'documentType','style'=>"visibility: hidden")); ?>		
		...
		<?php echo $form->hiddenField($model,'ID',array('id'=>'ownerId','name'=>'ownerId')); ?>		
				...
				<?php 
			                    ...
			                    'url' => Yii::app()->createUrl("team/uploadDocument",array("id"=>$model->ID)),
			                    'model' => $fileModel,
								'attribute' => 'file',
				 ...
				 <tr class="template-download fade in" style="height: 146px;">				  
					  <td colspan="2" class="preview">
            			...
            			<td class="name">
            			 ...
            			 <td class="delete">
					            <button class="btn btn-danger" data-type="<?php echo $document->DELTYPE;?>" data-url="<?php echo $document->DELURL.'&idDocumentModel='.$document->ID_DOCUMENT_TEAM;?>">
