...
class CatResultController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['CatResult']))
		{
			$model->attributes=$_POST['CatResult'];
			if($model->save())
	...
	{
		$model=new CatResult('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['CatResult']))
			$model->attributes=$_GET['CatResult'];
	 ...
	 * @return CatResult the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=CatResult::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param CatResult $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='cat-result-form')
		{
